<template>
  <!-- Labs passcode gate — same recipe as FinanceGate -->
  <div class="flex flex-1 flex-col items-center justify-center bg-white min-w-0 gap-[24px] px-[24px]">
    ...
    <div class="flex flex-col items-center gap-[16px] max-w-[400px] text-center">
      ...
      <div class="flex flex-col gap-[8px] items-center">
        <p class="text-[18px] font-medium text-[#03102f] leading-[1.35]">Labs is protected</p>
        <p class="text-[14px] font-normal text-[#61667c] leading-[1.5]">
          Enter the Labs passcode to continue. Ask the HitPay team if you don't have it.
        </p>
      </div>
    </div>
    ...
    <form class="flex flex-col items-center gap-[12px] w-[280px]" @submit.prevent="submit">
      ...
      >
        <span class="text-[14px] font-medium text-white leading-[1.5]" style="text-shadow: 0px 1px 1px rgba(0,0,0,0.12);">Unlock Labs</span>
      </button>
...
import { tryUnlockLabs } from '../../composables/useLabsAuth.js'
