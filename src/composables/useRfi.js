...
const FOLLOW_UP_MESSAGE = {
  ...
  lines: [
    'Hi Aarti,',
    'Thanks for the bank statement you sent over. One of the pages was cut off — could you resend page 3 so we can complete the review?',
    'Kind regards,\nEve Tan\nCompliance Analyst, HitPay',
  ],
}
...
const EXPIRED_MESSAGE = {
  ...
  lines: [
    'Hi Aarti,',
    'Could you share your last 3 months of bank statements to help us verify your account?',
    'Kind regards,\nEve Tan\nCompliance Analyst, HitPay',
  ],
}
...
export const rfiRequests = reactive([
  {
    ...
    due: '22/10/2026',
    overdue: false,
    itemsNote: '3 item requested',
    itemsAttention: false,
    agent: COMPLIANCE,
  ...
  },
  {
    id: 'rfi-3',
    code: 'RFI-1037',
    title: 'Request for 3 months bank statement',
    status: 'under_review',
    preview: PREVIEW,
    avatar: 'john',
    unread: false,
  ...
  },
  {
    ...
    due: '22/10/2026',
    overdue: false,
    itemsNote: '1 item need attention',
    itemsAttention: true,
    agent: COMPLIANCE,
    ...
    docsSent: false,
    showReadyBanner: false,
    flaggedItem: 'marketing_docs',
    flaggedMessage: 'Please re-upload this document. We’re unable to read them.',
  },
  {
    id: 'rfi-5',
    code: 'RFI-1039',
